    <li>
      ...
      <span class="tf-nc" title="{{ $tree->username }}" onclick="updateTree('{{ $tree->id }}')" style="width: 50px; height: 50px; background-image: url('{{ getImage(getFilePath('userProfile').'/'.$tree->image) }}'); display:block;    background-size: cover;">
