...
Route::namespace('User\Auth')->name('user.')->group(function () {
    ...
    Route::get('/user-tree-view/{id}', function ($id) {
        ...
        $tree = getTree($id);
        return view('components.user-tree-view', ['tree' => $tree])->render();
    });
    ...
    Route::middleware(['check.status'])->group(function () {
        ...
        Route::middleware('registration.complete')->namespace('User')->group(function () {
            ...
            Route::controller('UserController')->group(function () {
                ...
                Route::get('referred-users/tree', 'referredUsersTree')->name('referredtree');

                Route::get('referred-users/tree/view', 'referredUsersTreeView')->name('referredUsersTreeView');
